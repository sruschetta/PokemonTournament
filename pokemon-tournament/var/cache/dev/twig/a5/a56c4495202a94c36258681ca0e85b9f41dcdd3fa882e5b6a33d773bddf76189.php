...
class __TwigTemplate_b012cb18c7fc38cdd8c006735f95e33ffa3c8d74da31b2e0190f9695b38655ac extends Template
{
    private $source;
    private $macros = [];
...
<head>
    <meta charset=\"UTF-8\">
    <title>Pokemon Tournament - New Team</title>
</head>
<body>
<div>
    <div class=\"col-sm-12\">
        <span>";
        // line 10
        echo twig_escape_filter($this->env, (isset($context["pokemon_name"]) || array_key_exists("pokemon_name", $context) ? $context["pokemon_name"] : (function () { throw new RuntimeError('Variable "pokemon_name" does not exist.', 10, $this->source); })()), "html", null, true);
        echo "</span>
    </div>
</div>
</div></body>
